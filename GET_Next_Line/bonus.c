...
/*   Updated: 2022/05/03 14:26:12 by taitomer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	int		fd1 = open("testit/advancedtests", O_RDONLY);
	int		fd2 = open("testit/test1", O_RDONLY);
	int		fd3 = open("testit/test2", O_RDONLY);
	char	*line;
